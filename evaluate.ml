...
let check_claim board cl = 
  ...
  if py < boardY && (py land 1 = 1) then (
    ...
    board.instances.(baseclaim_) <- board.instances.(baseclaim_) + 1;
    if sol.solgroupsnumb > 0 then (
...
and rules_name = [|"CLAIMEVEN";"BASEINVERSE";"VERTICAL";"LOWINVERSE";
