(* OASIS_START *)
(* DO NOT EDIT (digest: db1d2853adbc7700a0a80281171fd36f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage =
            Some "http://forge.ocamlcore.org/projects/ocaml-mindstorm/";
          synopsis = "Drive Lego Mindstorms bricks from OCaml";
          description =
            Some
              [
                 OASISText.Para
                   "This library allows you to communicate with your Lego Mindstorms brick via bluetooth, enable the motors and retrieve data from various sensors."
              ];
          categories = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Whether libusb development files are installed";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "cppo"];
                      bs_c_sources = ["mindstorm_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                   ...
                   {
                      lib_modules =
                        ["Mindstorm"; "Mindstorm_NXT"; "Mindstorm_EV3"];
                      lib_pack = false;
                      lib_internal_modules = ["Mindstorm_common"];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Mindstorm";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = HTML "doc/intro.txt";
                      doc_data_files = [];
                      doc_build_tools =
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "tests/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "mindstorm"];
                   ...
                   {exec_custom = false; exec_main_is = "disconnect.ml"});
               Executable
                 ({
                     cs_name = "file_list";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "file_list.ml"});
               Executable
                 ({
                     cs_name = "info";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "info.ml"});
               Executable
                 ({
                     cs_name = "keep_alive";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "keep_alive.ml"});
               Executable
                 ({
                     cs_name = "motor";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "motor.ml"});
               Executable
                 ({
                     cs_name = "sensors";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "sensors.ml"});
               Executable
                 ({
                     cs_name = "sound";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "sound.ml"});
               Executable
                 ({
                     cs_name = "upload";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "upload.ml"});
               Executable
                 ({
                     cs_name = "ev3_sound";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "ev3_sound.ml"});
               Executable
                 ({
                     cs_name = "roam";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "roam.ml"});
               Executable
                 ({
                     cs_name = "run_push";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "run_push.ml"});
               Executable
                 ({
                     cs_name = "test_speed";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_speed.ml"});
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_threads.ml"});
               Executable
                 ({
                     cs_name = "wander";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "wander.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/Chris00/ocaml-mindstorm.git";
                      src_repo_browser =
                        Some "https://github.com/Chris00/ocaml-mindstorm";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\196\233`\202FHV]-\159.\150\184\158!\006";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
