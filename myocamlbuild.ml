(* OASIS_START *)
(* DO NOT EDIT (digest: 848a428c684f162b95064ff167430e7e) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("mindstorm", ["src"], [])];
     lib_c = [("mindstorm", "src", [])];
     flags =
       [
          (["oasis_library_mindstorm_ccopt"; "compile"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.EAnd
                  (OASISExpr.ETest ("system", "linux"),
                    OASISExpr.EFlag "has_usb"),
                 S [A "-ccopt"; A "-DHAS_USB"]);
               ...
               (OASISExpr.EAnd
                  (OASISExpr.ETest ("architecture", "amd64"),
                    OASISExpr.EAnd
                      (OASISExpr.ETest ("system", "linux"),
                        OASISExpr.EFlag "has_usb")),
                 S [A "-ccopt"; A "-DARCH64"; A "-ccopt"; A "-DHAS_USB"]);
               (OASISExpr.ETest ("system", "msvc"),
                 S [A "-ccopt"; A "/nologo"; A "-ccopt"; A "/DWIN32"]);
               (OASISExpr.ETest ("system", "macosx"),
                 S [A "-ccopt"; A "-DMACOSX"])
            ]);
          (["oasis_library_mindstorm_cclib"; "link"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.EAnd
                  (OASISExpr.ETest ("system", "linux"),
                    OASISExpr.EFlag "has_usb"),
                 S [A "-cclib"; A "-lusb-1.0"]);
               (OASISExpr.ETest ("system", "linux"),
                 S [A "-cclib"; A "-lbluetooth"]);
               (OASISExpr.EAnd
                  (OASISExpr.ETest ("system", "linux"),
                    OASISExpr.EAnd
                      (OASISExpr.ETest ("system", "linux"),
                        OASISExpr.EFlag "has_usb")),
                 S [A "-cclib"; A "-lbluetooth"; A "-cclib"; A "-lusb-1.0"]);
               (OASISExpr.ETest ("system", "msvc"),
                 S
                   [
                      A "-cclib";
                      A
                        "/IC:\\Program Files\\Microsoft Platform SDK\\Include"
                   ]);
               (OASISExpr.ETest ("system", "macosx"),
                 S
                   [
          ...
          (["oasis_library_mindstorm_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true, S []);
               (OASISExpr.EAnd
                  (OASISExpr.ETest ("system", "linux"),
                    OASISExpr.EFlag "has_usb"),
                 S [A "-lusb-1.0"]);
               (OASISExpr.ETest ("system", "linux"), S [A "-lbluetooth"]);
               (OASISExpr.EAnd
                  (OASISExpr.ETest ("system", "linux"),
                    OASISExpr.EAnd
                      (OASISExpr.ETest ("system", "linux"),
                        OASISExpr.EFlag "has_usb")),
                 S [A "-lbluetooth"; A "-lusb-1.0"]);
               (OASISExpr.ETest ("system", "msvc"),
                 S [A "/IC:\\Program Files\\Microsoft Platform SDK\\Include"]);
               (OASISExpr.ETest ("system", "macosx"),
                 S
                   [
                      A "-I";
