...
let connected board move =
  ...
  let h_l = hori_left (move-1) 0
  and d_nw_l = diago_NW_left (move-1) (board.stack.(move)+1) 0
  and d_ne_l = diago_NE_left (move-1) (board.stack.(move)-1) 0 in
  ...
  and v = verti (board.stack.(move)-1) 0 in
